  ...
  return (
    <div className="fixed bottom-4 left-4 z-40 bg-white dark:bg-slate-900 p-4 rounded-lg shadow-lg border">
      ...
      <div className="flex flex-col gap-2">
        <Button size="sm" onClick={handleTestSuccess} className="text-xs">Success</Button>
        <Button size="sm" onClick={handleTestError} variant="destructive" className="text-xs">Error</Button>
        <Button size="sm" onClick={handleTestWarning} variant="outline" className="text-xs">Warning</Button>
        <Button size="sm" onClick={handleTestInfo} variant="outline" className="text-xs">Info</Button>
        <Button size="sm" onClick={handleTestEmpty} variant="ghost" className="text-xs">Empty</Button>
      </div>
